...
<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
  ...
  const TG_TASK_TYPES = [
  { id: "sub_channel", title: "Подписка на канал", reward: 5, cost: 5, desc: "2 дня обязательного удержания. Бот проверяет, что исполнитель не вышел из канала." },
  { id: "join_group", title: "Вступление в группу", reward: 5, cost: 5, desc: "2 дня обязательного удержания. Бот проверяет, что исполнитель не вышел из группы." },
